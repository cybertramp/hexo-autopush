...
git -C YOUR_GITHUB_ID.github.io_directory_path add .
git -C YOUR_GITHUB_ID.github.io_directory_path commit -m "commit!"
git -C YOUR_GITHUB_ID.github.io_directory_path push origin master
